    ...
    <div className='my-10'>
      ...
      <div className='flex flex-col my-5 gap-5 '>
        <div className='flex flex-col my-5 p-5 rounded-lg border gap-5'>
          <h2 className='text-lg'><strong>Job Role/Job Position:</strong>{interviewData}</h2>
          <h2 className='text-lg'><strong>Job Description/Tech Stack:</strong>{interviewData}</h2>
          <h2 className='text-lg'><strong>Years of Experience:</strong>{interviewData}</h2>
          </div>
